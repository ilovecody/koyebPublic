...
import ray.lee.common.exceptions.TooManyRequestsException;
import ray.lee.common.pojo.vo.RestapiLimitationVO;
...
public class RestapiLimitationCheckAspect {
	...
	@Pointcut(value = "@within(ray.lee.myRestApi.aop.annotation.RestapiLimitationCheck)")
	public void classPointcut() {
		
	}
	
	@Pointcut(value = "@annotation(ray.lee.myRestApi.aop.annotation.RestapiLimitationCheck)")
